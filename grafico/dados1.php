...
FROM (
            ...
            SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1) AS unidade, 
            SUBSTRING_INDEX(HOST,'_',-1) as tipo, 
            if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),3) = 'HS.' , 'hospital', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),3) = 'VI.' , 'vidaeimagem', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),7) = 'HAPCLI.' , 'hapclinica', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),3) = 'PA.' , 'prontoatendimento', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),3) = 'CD.' , 'centrodedistribuicao', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),8) = 'MEDPREV.' , 'medprev', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),4) = 'LAB.' , 'laboratorio', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),4) = 'ADM.' , 'administrativo', if( LEFT( SUBSTRING_INDEX(if(LOCATE('.',SUBSTRING_INDEX(host,'_',-2)) > 0 , SUBSTRING_INDEX(host,'_',-2),SUBSTRING_INDEX(host,'_',-3)),'_',1),4) = 'AMB.' , 'ambulatorio', 'outros' ) ) ) ) ) ) ) ) )   as modalidade, 
            hostid 
